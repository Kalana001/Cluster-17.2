...
Class Action {
    ...
    function get_parcel_heistory(){
        ...
        if($parcel->num_rows <=0){
            ...
            $status_arr = array("","Pending","Accepted by Post Office","Arrived At Destination","Out for Delivery","Delivered","Fail to Deliver","Returned","Picked-up","Item Accepted by Courier");
