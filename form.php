          ...
          <form class="form-card" method="post" action="formProcess.php">
            <div class="row justify-content-between text-left">
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3" for="sender_name">Sender Name<span class="text-danger"> *</span></label>
                <input type="text" id="Yourname" name="sender_name" placeholder="Your name" required onblur="validate(1)">
              </div>
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3">Reciver Name<span class="text-danger"> *</span></label>
                <input type="text" id="Recivername" name="recipient_name" placeholder="Reciver name" required onblur="validate(2)">
              </div>
            </div>
            <div class="row justify-content-between text-left">
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3">Sender Address<span class="text-danger"> *</span></label>
                <input type="text" id="YourAddress" name="sender_address" required placeholder="Sender Address" onblur="validate(3)">
              </div>
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3">Reciver Address<span class="text-danger"> *</span></label>
                <input type="text" id="ReciverAddress" name="recipient_address" required placeholder="Reciver Address" onblur="validate(4)">
              </div>
            </div>
            <div class="row justify-content-between text-left">
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3">Contact number<span class="text-danger"> *</span></label>
                <input type="text" id="YourContactNumber" required placeholder="Contact number" name="sender_contact" onblur="validate(5)">
              </div>
              <div class="form-group col-sm-6 flex-column d-flex">
                <label class="form-control-label px-3">Contact number<span class="text-danger"> *</span></label>
                <input type="text" id="ReciverContactNumber" required placeholder="Contact number" name="recipient_contact" onblur="validate(6)">
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <small>If the customer want to deliver the package to their address fill the checkbox</small>
              <small></small>
            </div>
          </div>
