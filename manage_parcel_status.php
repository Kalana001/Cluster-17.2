...
<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("","Pending","Accepted by Post Office","Arrived At Destination","Out for Delivery","Delivered","Fail to Deliver","Returned","Picked-up","Item Accepted by Courier"); ?>
